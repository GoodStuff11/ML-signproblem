#!/bin/bash
#SBATCH --job-name=benchmark_timings_exact_cpu80
#SBATCH --output=/home/jek354/research/ML-signproblem/jobs/logs/benchmark_timings_exact_cpu80_%j.out
#SBATCH --error=/home/jek354/research/ML-signproblem/jobs/logs/benchmark_timings_exact_cpu80_%j.err
#SBATCH --partition=aimi
#SBATCH --cpus-per-task=80
#SBATCH --mem=120g
#SBATCH --time=7-00:00:00

# Forward-pass / gradient timings for the exact code on 80 CPU cores.
