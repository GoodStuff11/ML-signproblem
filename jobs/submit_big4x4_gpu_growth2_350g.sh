...
/usr/bin/time julia --project=.. run_trotter_scan_optimization.jl "N=(6, 6)_4x4" 33 33 --loss=overlap --antihermitian --custom_ref_state=slater --num_exponentials=2 --grow_from_exponentials=1 --grow_mode=chain --maxiters=300 --use_gpu --datatype=Float32
