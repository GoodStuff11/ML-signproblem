#!/bin/bash
#SBATCH --job-name=repeat_opt_3x2_32_noreg
#SBATCH --output=/home/jek354/research/ML-signproblem/jobs/repeat_opt_3x2_u32_noreg-%A_%a.out
#SBATCH --error=/home/jek354/research/ML-signproblem/jobs/repeat_opt_3x2_u32_noreg-%A_%a.err
#SBATCH --mem=8g
...
# Same experiment as submit_repeat_optimization_3x2_3_2_u32.sh, but with the exact
...
# U = 8.0 (u index 32), for each of the four (ansatz, loss) combinations, split over
...
MAXITERS=1000
BASE_SEED=20260915
OUTDIR=/home/jek354/research/ML-signproblem/experimenting/ed/repeat_optimization_3x2_3_2_u32_noreg
