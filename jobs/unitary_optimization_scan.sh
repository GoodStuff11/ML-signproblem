#!/bin/bash
#SBATCH -J 4x3                                   # Job name
#SBATCH -o scan_unitary_optimization_4x3_%j.out       # output file (%j expands to jobID)
#SBATCH -e scan_unitary_optimization_4x3_%j.err       # error log file (%j expands to jobID)
